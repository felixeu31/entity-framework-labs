...
{
    public class QueryableBatchGeneratorInMemoryDbIntegrationTest : IClassFixture<InMemoryIntegrationTestFixture>
    {
        private readonly InMemoryIntegrationTestFixture _fixture;

        public QueryableBatchGeneratorInMemoryDbIntegrationTest(InMemoryIntegrationTestFixture fixture)
        {
